...
TWEET_MAX_CHARS = 240  # headroom under X's 280 limit for URLs/emoji rendering quirks
...
THREAD_SYSTEM_PROMPT_BASE = (
    ...
    f"각 트윗은 {TWEET_MAX_CHARS}자를 넘지 않게 짧고 리듬감 있게 끊어 스레드로 구성하세요. "
...
def write_x_thread(note: str, photo_captions: List[str], brand_kit: dict, vendor: str) -> dict:

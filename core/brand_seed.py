...
# --- visual identity --------------------------------------------------------
# CJC 제안 팔레트 (네이비 신뢰 + 골드 포인트). Flet 테마(flet_app/theme.py)가 이 값을 그대로 씁니다.
BRAND_COLORS = {
...
TONE_AND_MANNER = """- 부드러운 경어체(해요체/하십시오체 혼용)를 씁니다.
...
# limit.
SEED_FIXES = [
    ('- 부드러운 경어체(해요체/하십시오체 혼용)를 씁니다. 문장은 2~3줄 안에서 끊습니다.',
     '- 부드러운 경어체(해요체/하십시오체 혼용)를 씁니다.\n- 한 문장은 40자 안팎에서 끊고, 한 문단은 2~3문장까지만 씁니다. 같은 뜻을 두 번 말하지 않습니다.'),
]
